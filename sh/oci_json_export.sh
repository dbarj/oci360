...
# Limits-Services,oci_limits_service.json,jsonAllCompartAddTag,"limits service list --all"
# Limits-Quotas,oci_limits_quota.json,jsonAllCompartAddTag,"limits quota list --all"
# Limits-Values,oci_limits_value.json,jsonGenericMasterAdd,"limits value list --all" "Limit-Services" "name:service-name:service-name:compartment-id:compartment-id:compartment-id" "jsonSimple"
# Limits-ResAvail,oci_limits_res-avail.json,jsonGenericMasterAdd,"limits resource-availability get" "Limit-Values" "name:limit-name:limit-name:service-name:service-name:service-name:compartment-id:compartment-id:compartment-id:availability-domain:availability-domain:availability-domain" "jsonSimple"
